...
public class MedicMonitorDsa {
    ...
    private String qualityStatus; //质量评估状态：质量评估状态，直接存中文:未评估，已评估，默认值为未评估

    private String qualityEvaluateName; //质量评估人姓名

    private Integer qualityEvaluateId;  //质量评估人Id

    private String qualityHandGradeJSON;//'质量评估人工打分JSON串',[{itemName:'医院名称',itemInfo:'评分项说明',itemRuleGrade:'评分项设定分值'，itemHandGrade:'评分项打分分数'},{},{},...]

    private String qualityHandGradeTotal;//质量评估人工打分总分
    ...
    public String getQualityHandGradeJSON() {
        return qualityHandGradeJSON;
    }

    public void setQualityHandGradeJSON(String qualityHandGradeJSON) {
        this.qualityHandGradeJSON = qualityHandGradeJSON;
    }

    public String getQualityHandGradeTotal() {
        return qualityHandGradeTotal;
    }

    public void setQualityHandGradeTotal(String qualityHandGradeTotal) {
        this.qualityHandGradeTotal = qualityHandGradeTotal;
    }
    ...
    public String getQualityEvaluateName() {
        return qualityEvaluateName;
    }

    public void setQualityEvaluateName(String qualityEvaluateName) {
        this.qualityEvaluateName = qualityEvaluateName;
    }

    public Integer getQualityEvaluateId() {
        return qualityEvaluateId;
    }

    public void setQualityEvaluateId(Integer qualityEvaluateId) {
        this.qualityEvaluateId = qualityEvaluateId;
    }
}